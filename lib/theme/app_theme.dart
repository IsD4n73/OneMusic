...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xFFf50514),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFFffffff),
      onPrimaryContainer: Color(0xFFcd0000),
      ...
      inversePrimary: Color(0xFFe10000),
      primaryFixed: Color(0xFFff5564),
      onPrimaryFixed: Color(0xFFb90000),
      primaryFixedDim: Color(0xFFff4150),
      onPrimaryFixedVariant: Color(0xFFe10000),
      secondaryFixed: Color(0xFFffffff),
      onSecondaryFixed: Color(0xFFc3c3c3),
      secondaryFixedDim: Color(0xFFffffff),
      onSecondaryFixedVariant: Color(0xFFebebeb),
      tertiaryFixed: Color(0xFF505050),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(0xFFf50514),
      primaryFixed: Color(0xFFff5564),
      onPrimaryFixed: Color(0xFFb90000),
      primaryFixedDim: Color(0xFFff4150),
      onPrimaryFixedVariant: Color(0xFFe10000),
